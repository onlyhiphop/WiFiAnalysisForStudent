...
public class BaseDriver {
    ...
    public static void initJob(JobInitModel[] jobs) throws IOException, ClassNotFoundException, InterruptedException {
        for (JobInitModel jobInitModel :
            ...
            //Partitioner设置
            if(jobInitModel.getPartitionnerClass() != null){
                job.setPartitionerClass(jobInitModel.getPartitionnerClass());
                job.setNumReduceTasks(jobInitModel.getNumberReduceTask());
            }
